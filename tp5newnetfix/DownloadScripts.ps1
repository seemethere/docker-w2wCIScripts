...
try {
	...
	# TP5 new network fix
    $wc=New-Object net.webclient;$wc.Downloadfile("https://raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/tp5newnetfix/DownloadScripts.ps1","c:\packer\DownloadScripts.ps1")
    $wc=New-Object net.webclient;$wc.Downloadfile("https://raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/tp5newnetfix/InstallOSImages.ps1","c:\packer\InstallOSImages.ps1")
    $wc=New-Object net.webclient;$wc.Downloadfile("https://raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/tp5newnetfix/InstallPrivates.ps1","c:\packer\InstallPrivates.ps1")
    $wc=New-Object net.webclient;$wc.Downloadfile("https://raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/tp5newnetfix/InstallZDP.ps1","c:\packer\InstallZDP.ps1")
