...
try {
    ...
    # ZDPs are now in the VHDs as of v57. Tried Large File Storage but could work out how to redirect even with curl. Probably a way somehow.
    ...
    # Let's move forward to 6D. Don't need any of the first 5 which are a second attempt at the network retry hack.
    # The kernel made it into 6D
    # wcifs made it into 5B (I think))
