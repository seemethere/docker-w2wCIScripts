...
try {
    ...
    if ($env:LOCAL_CI_INSTALL -eq 1) {
        ...
        copy "\\redmond\osg\Teams\CORE\BASE\HYP\Public\mebersol\temp\containers\TP5 images\V3\CBaseOs_rs1_release_svc_14300.1000.160324-1723_amd64fre_ServerDatacenterCore_en-us.wim" c:\BaseImages\windowsservercore.wim
