...
try {
    ...
    $wc=New-Object net.webclient;$wc.Downloadfile("https:\raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/TP5/common/authorized_keys","c:\packer\authorized_keys")
    $wc=New-Object net.webclient;$wc.Downloadfile("https:\raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/TP5/common/ConfigureCIEnvironment.ps1","c:\packer\ConfigureCIEnvironment.ps1")
    ...
    $wc=New-Object net.webclient;$wc.Downloadfile("https:\raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/TP5/common/InstallMostThings.ps1","c:\packer\InstallMostThings.ps1")
    $wc=New-Object net.webclient;$wc.Downloadfile("https:\raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/TP5/common/nssmdocker.cmd","c:\docker\nssmdocker.cmd")
