...
try {
    ...
    $wc=New-Object net.webclient;$wc.Downloadfile("https://raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/RS1/DownloadScripts.ps1","$env:SystemDrive\packer\DownloadScripts.ps1")
