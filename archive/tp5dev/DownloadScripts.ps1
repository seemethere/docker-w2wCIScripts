...
echo "$(date) DownloadScripts.ps1 Starting (tp5dev)..." >> $env:SystemDrive\packer\configure.log
...
try {
    ...
    # TP5 development version files
    $wc=New-Object net.webclient;$wc.Downloadfile("https://raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/tp5dev/DownloadScripts.ps1","c:\packer\DownloadScripts.ps1")
    $wc=New-Object net.webclient;$wc.Downloadfile("https://raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/tp5dev/DownloadOSImages.ps1","c:\packer\DownloadOSImages.ps1")
    $wc=New-Object net.webclient;$wc.Downloadfile("https://raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/tp5dev/InstallPrivates.ps1","c:\packer\InstallPrivates.ps1")
    $wc=New-Object net.webclient;$wc.Downloadfile("https://raw.githubusercontent.com/jhowardmsft/docker-w2wCIScripts/master/tp5dev/InstallZDP.ps1","c:\packer\InstallZDP.ps1")
